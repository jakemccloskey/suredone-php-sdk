...
$username = 'yd';
/** for fullfilment:
* Standard codes: NOTRACKING|REFUNDED|CANCELED|PICKUP ( will not be read as tracking number )
* Special codes: PENDING|ORDERED|SHIPPED|DROPSHIPPED ( will not sync or email customer )
*
 * update order
 */
try{
